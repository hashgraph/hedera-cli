            ...
            if (this.transitionToState([connectivity_state_1.ConnectivityState.CONNECTING], connectivity_state_1.ConnectivityState.READY)) {
                ...
                transport.addDisconnectListener((tooManyPings) => {
                    ...
                    if (tooManyPings) {
                        ...
                        logging.log(constants_1.LogVerbosity.ERROR, `Connection to ${uri_parser_1.uriToString(this.channelTarget)} at ${this.subchannelAddressString} rejected by server because of excess pings. Increasing ping interval multiplier to ${this.keepaliveTimeMultiplier} ms`);
                    }
                });
            }
        }, error => {
