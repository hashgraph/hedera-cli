...
export default class TopicMessageQuery extends Query<TopicMessageQuery> {
     ...
     */
    subscribe(client: import("../client/Client.js").default<import("../channel/Channel.js").default, import("../channel/MirrorChannel.js").default>, errorHandler: ((message: TopicMessage | null, error: Error) => void) | null, listener: (message: TopicMessage) => void): SubscriptionHandle;
    /**
     * @private
     * @param {Client<Channel>} client
     * @returns {void}
